...
public class NimParserTest extends ParsingTestCase {
    ...
    public void testMiscArrayIndented2() {
        doTest(true, true);
    }
    ...
    public void testMiscPopWithoutComment() {
        doTest(true, true);
    }
    ...
    public void testMiscStrOp() {
        doTest(true, true);
    }

    public void testMiscTemplate() {
        doTest(true, true);
    }

    public void testMiscType() {
        doTest(true, true);
    }

    public void testMiscType2() {
        doTest(true, true);
    }
