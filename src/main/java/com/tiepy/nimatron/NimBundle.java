/*
 * This file is based on CfmlBundle.java from the IntelliJ plugins collection.
...
public class NimBundle extends DynamicBundle {
    @NonNls private static final String BUNDLE = "messages.NimBundle";
    private static final NimBundle INSTANCE = new NimBundle();

    private NimBundle() { super(BUNDLE); }
