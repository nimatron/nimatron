...
public class NimTupleConstrImpl extends ASTWrapperPsiElement implements NimTupleConstr {

  public NimTupleConstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NimVisitor visitor) {
    visitor.visitTupleConstr(this);
  }
