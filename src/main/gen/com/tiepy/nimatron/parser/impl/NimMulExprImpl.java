...
public class NimMulExprImpl extends ASTWrapperPsiElement implements NimMulExpr {

  public NimMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NimDollarExpr> getDollarExprList() {
