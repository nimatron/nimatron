...
public class NimExtTupleDeclImpl extends ASTWrapperPsiElement implements NimExtTupleDecl {

  public NimExtTupleDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NimVisitor visitor) {
    visitor.visitExtTupleDecl(this);
  }
